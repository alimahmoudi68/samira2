    ...
    <div class="container mx-auto my-3 flex flex-col items-end">
        <div class="w-full flex flex-wrap">
            <div class="w-full md:w-9/12 md:order-2">
                <div
                    class='flex flex-col justify-center items-start bg-white-100 p-5 rounded-md shadow-my mb-2 dark:bg-dark-card-100 dark:shadow-none'>
                    <?php 
                    ...
                    <h1
                        class='w-full text-2xl text-slate-700 md:text-4xl font-extrabold text-right my-2 md:mt-[30px] dark:text-text-primary-100'>
                        <?php the_title(); ?>
                    </h1>
            ...
            <div class="w-full md:w-3/12 md:order-1">
                <div class='md:ml-3 md:mt-0 mt-3'>
                    <div class='flex flex-wrap'>
                        <div class='w-1/2'>
                            <div
                                class='p-1 bg-white-100 h-[100px] flex flex-col justify-center items-center shadow-my md:mb-1 dark:bg-dark-card-100 dark:shadow-none'>
                                ...
                                <span class='text-xs sm:text-base font-semibold text-gray-700 dark:text-text-primary-100'
                                    dir='ltr'>
                        ...
                        <div class='w-1/2'>
                            <div
                                class='p-1 bg-white-100 h-[100px] flex flex-col justify-center items-center shadow-my mr-2 md:mb-2 dark:bg-dark-card-100 dark:shadow-none'>
                ...
                <?php
                        ...
                        ?>
                        <div
                            class='teacher-prof flex flex-col justify-center items-center bg-white-100 rounded-xl p-3 mt-3 shadow-my md:mt-2 md:ml-3 dark:bg-dark-card-100 dark:shadow-none'>
                                <?php the_post_thumbnail('teacher'); ?>
                            <span class='text-lg font-bold mt-[5px] text-gray-700 text-justify dark:text-text-primary-100'>
        ...
        <div class="w-full md:w-9/12 woocommerce">
            <div id="comment-section" class='w-full bg-white-100 dark:bg-dark-card-100 flex flex-col justify-center items-center shadow-my dark:shadow-none p-5 rounded-md text-[0.9rem] font-normal my-3'>
