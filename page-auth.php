...
<main class='w-full grow h-full flex flex-col items-center justify-center pt-[80px] md:pt-[100px] md:pb-[100px] px-2 relative'>
    <div class="w-full overflow-y-hidden flex flex-col max-w-[400px] bg-white-100 rounded-md p-5 my-[100px]">
        <span class="mx-auto mb-6 font-black text-text-primary-100">
            ورود به حساب کاربری
        </span>
        <div id="card-send-otp" class="w-full flex flex-col duration-300">
            <?php if($redirect == 'checkout'){ ?>
            <span class="mb-5 text-sm text-text-primary-100 text-start">
            ...
            <?php } ?>
            <div>
                <input name='phone' type="text" autocomplete="off" inputmode='tel' class="w-full h-10 bg-background-100 text-text-primary-100 font-dana outline-hidden rounded-md px-[10px] py-p[5px]" placeholder="شماره موبایل"/>
        ...
        <div id="card-verify" class="w-full flex-col translate-y-[300px] duration-300 hidden">
            <span class="mx-auto mb-5 text-text-primary-100">
                کدی که به شماره موبایل شما ارسال شد را وارد کنید
            </span>
            <input name='token' class="hidden" id='token-input' value=""/>
            <input name='otp' autocomplete="off" type="text" class="w-full h-10 text-center text-text-primary-100 bg-background-100 font-dana outline-hidden rounded-md px-[10px] py-p[5px]" placeholder="- - - - -"/>
            <div class='flex justify-start h-5 mt-2'>
                <div class="verify-timer text-text-primary-100 text-[0.7rem]">
        ...
        <div id="card-register" class="w-full flex-col translate-y-[300px] duration-300 hidden">
            <span class="mx-auto mb-5 text-sm text-text-primary-100">
                برای تکمیل ثبت نام لطفا نام و نام خانوادگی خود را وارد نمایید
            </span>
            <div>
                <input name='name' type="text" autocomplete="off" class="w-full h-10 font-dana outline-hidden rounded-lg text-text-primary-100 bg-background-100 px-[10px] py-p[5px]" placeholder="نام و نام خانوادگی"/>
                <small class="w-full text-start font-semibold text-red-400 mt-1 invisible">خطا</small>
            </div>
