...
?>
<footer 
    class='w-full bg-top bg-cover bg-no-repeat bg-dark-back-100 text-sm font-normal leading-6 px-5 py-3 text-center text-white-100'>
      ...
      <div class='w-fll flex flex-wrap justify-around md:justify-between'>
        <div class='w-full text-center py-3 md:w-[20%]'>
          <div class='bg-primary-100 p-3 rounded-lg mb-3'>
              ...
              ما دوتا خواهر علاقه‌مند به حوزه زیبایی با بیشتر از 10 سال تجربه فعالیت این وب سایت رو جهت آموزش های تخصصی حوزه های زیبایی راه اندازی کردیم که بتونید از تجربیاتمون استفاده کنید و آزمون خطایی توی کارتون نداشته باشید.
              </span>
            </div>
            <div class='bg-primary-100 p-3 rounded-lg'>
              ...
              <div class='flex gap-x-3 justify-center items-center'>
                <?php if($my_opt['opt-insta'] !== ''){ ?>
                <a href="https://instagram.com/<?php echo $my_opt['opt-insta'] ?>">
                  <svg class='group-hover:stroke-white-100 dark:stroke-white-100' fill="#fff"
                ...
                <?php } ?>
                <?php if($my_opt['opt-telegram'] !== ''){ ?>
                <a  href="https://t.me/<?php echo $my_opt['opt-telegram'] ?>">
                  <svg class='stroke-white-100' fill="#fff" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class='w-full md:w-[25%] md:text-start py-3 md:pr-10'>
          ...
          <?php if($my_opt['opt-office-phone'] !== ''){ ?>
          <span class='flex block justify-center md:justify-start'>
            شماره ثابت:
            <a class='mr-1' href="tel:<?php echo $my_opt['opt-office-phone'] ?>">
              <?php echo $my_opt['opt-office-phone'] ?>
            </a>
          </span>
          <?php } ?>
          <?php if($my_opt['opt-phone'] !== ''){ ?>
          <span class='flex block justify-center md:justify-start'>
            شماره همراه:
            <a class='mr-1' href="tel:<?php echo $my_opt['opt-phone'] ?>">
              <?php echo $my_opt['opt-phone'] ?>
            </a>
          </span>
          <?php } ?>
          <?php if($my_opt['opt-address'] !== ''){ ?>
          <span class='flex whitespace-normal'>
            آدرس:
            <?php echo $my_opt['opt-address'] ?>
          </span>
          <?php } ?>
        </div>

        <div class='w-full md:w-[30%] flex py-3 pl-2'>
          <div id="map" class='w-full h-[200px] md:h-full rounded-lg'></div>
        </div>


        <div class='w-full text-center justify-center bg-dark-card-100 rounded-lg'>
          <div class='pt-2'>
            <small>کلیه حقوق این سایت متعلق به سایت <?php echo get_bloginfo('name'); ?> می‌باشد.</small>
          </div>
          <span class='text-[0.7rem]'>
            طراحی و اجرا:
          </span>
          <span class='text-[0.7rem]' dir='ltr'>
            0915 830 2458
          </span>
        </div>
