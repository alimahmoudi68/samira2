...
<div class="container mx-auto">
    <div class='my-5 py-2 dark:text-text-primary-100'>
        <span class="text-xl md:text-3xl font-bold text-slate-700 dark:text-text-primary-100">رخ‌تاپ تی‌وی</span>
    ...
    <div class="flex flex-wrap" id="main">
        ...
        <div class="w-full md:w-9/12 md:order-2">
            ...
            <div class="flex flex-wrap px-[-6px]">
            <?php while(have_posts()) : the_post(); ?>
                    <div class="w-full sm:w-1/2 md:w-1/3 px-[6px]">
                        <?php wc_get_template_part( 'template/card', 'tv2' ); ?>
                    </div>
                <?php endwhile; ?>
            </div>
