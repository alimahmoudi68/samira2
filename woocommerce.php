    ...
    <div class="container mx-auto px-2 pt-[75px] md:pt-[100px]">
        ...
        <div
            ...
            <div class='w-full grow flex flex-col justify-between items-between grow lg:order-first mt-2 lg:mt-0 lg:ml-5 relative'>
                <div>    
                    <h1
                        class='w-full text-2xl mb-2 lg:text-4xl font-extrabold text-center lg:text-right text-text-primary-100'>
                        <?php the_title(); ?>
                    </h1>
                    <span
                        class='text-justify font-light leading-6 lg:mt-5 text-text-primary-100'>
                        <?php the_excerpt(); ?>
                    </span>
                </div>
                    ...
                    <div class='flex flex-col lg:flex-row justify-center lg:justify-between items-center mt-3'>
                        ...
                        <div class='inline-flex'>
                            ...
                            <div class='mt-2 flex flex-col items-center'>
                                ...
                                <?php } ?>
                                       <span class='text-xl font-semibold ml-1 text-text-primary-100'>
                                    <?php
        ...
        <div class="w-full flex justify-between flex-wrap gap-3 mb-3">
                ...
                <div class='w-full h-full flex flex-col gap-y-3 bg-white-100 rounded-lg p-5'>
                    <div class='w-full h-full flex gap-x-2 justify-between'>
                        <div class='w-[49%] flex flex-col gap-y-2 lg:flex-row justify-between items-center bg-background-100 rounded-lg p-2'>
                            ...
                            <div class='w-[50%]'>
                                <span class='text-text-primary-100 text-center text-[0.9rem] block'>
                        ...
                        <div class='w-[49%] flex flex-col gap-y-2 lg:flex-row justify-between items-center bg-background-100 rounded-lg p-2'>
                            ...
                            <div class='w-[50%]'>
                                <span class='text-text-primary-100 text-center text-[1rem] block'>
                                    5.0
                                </span>
                                <span class='text-white-70 text-center text-[0.9rem] block'>
                                    رضایت
                    ...
                    <div>
                        <div class='flex justify-between items-center mb-1'>
                            <span class='text-text-primary-100 text-[1rem] block'>
                                درصد تکمیل دوره
                            </span>
                            <span class='text-text-primary-100 text-[1rem] block'>
            ...
            <div class="w-full flex justify-between flex-wrap gap-[12px] lg:w-[calc(75%-8px)]">
                <div class='w-[calc(50%-6px)] sm:w-[calc(33%-6px)] flex flex-col items-center lg:flex-row lg:justify-center gap-x-3 p-5 rounded-lg bg-white-100'>
                    ...
                    <div>
                        <span class='text-[1rem] text-center font-normal mt-2  text-text-primary-100 block'>
                            وضعیت دوره
                        </span>
                        <span class='text-xs sm:text-base text-center font-semibold text-text-primary-100 block'>
                            <?php 
                            $status=  get_post_meta( get_the_ID() , 'product_status' , true);
                            if($status == 'soon'){
                                echo 'به زودی';
                ...
                <div class='w-[calc(50%-6px)] sm:w-[calc(33%-6px)] flex flex-col items-center lg:flex-row lg:justify-center gap-x-3 p-5 rounded-lg bg-white-100'>
                    ...
                    <div>
                        <span class='text-[1rem] text-center text-center font-normal mt-2 text-text-primary-100 block'>
                            زمان دوره
                        </span>
                        <span class='text-xs sm:text-base font-semibold text-text-primary-100 block'>
                            <?php 
        ...
        <div class="w-full flex justify-between flex-wrap gap-3 mb-3">
            <div class="w-full lg:w-[calc(75%-8px)] lg:order-2">
                    ...
                    <div class='w-full flex justify-start items-center mb-5'>
                        ...
                        <?php if ( $is_buy ) {
                            $spotplayer_key = amzshyar_user_products_buys_spotplayer_key(); ?>
                                <span class='mb-3 block text-justify text-base text-text-primary-100'>باتوجه به سیستم عامل خود یکی از نسخه های موجود اسپات پلیر را دانلود و نصب کنید. بعد از نصب از طریق لایسنس زیر وارد نرم افزار شوید. بعد از وارد کردن لایسنس بصورت خودکار به محتوای دوره هدایت خواهید شد.</span>
                                <div class="text-text-primary-100">
                                    <span class='mb-3 block font-bold'>لایسنس شما:</span>
                                    <?php if( ! empty( $spotplayer_key[$id_post] ) && ! empty( $spotplayer_key[$id_post]['key'] ) ) { ?>
                                    <code dir='ltr' class="product-spotplayer-lic-str block bg-primary-100 p-4 rounded-md text-text-primary-100 mb-3 relative">
                                    ...
                                    <?php } else { ?>
                                    <div class="block bg-primary-100 p-3 rounded-md text-text-primary-100 mb-3">
                                    ...
                                    <p class='text-text-primary-100 flex items-center'>
                        ...
                        <?php } else {  ?>
                                <span class='block text-justify text-base text-text-primary-100 mb-2'>بعد از ثبت نام در این دوره، کلید لایسنس دوره در اختیار شما قرار خواهد گرفت. شما با قرار دادن کلید لایسنس در نرم افزار اسپات‌پلیر میتوانید به راحتی ویدیوهای دوره را مشاهده کنید.</span>
                                <p class='text-text-primary-100 flex items-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="stroke-white-100 w-[25px] h-[25px] ml-1">
                ...
                <div
                    ...
                    <div class='more-content w-full leading-8 text-base font-light mt-3 relative transition-all duration-900 overflow-hidden text-text-primary-100'
                    ...
                    <button
                        ...
                        <span class="group-hover:text-text-primary-100 text-text-primary-100">
                            ادامه مطلب
                        </span>
                        <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div
                    ...
                    <div
                        ...
                        <div class='flex justify-start items-center'>
                            <div
                                ...
                                <span
                                    class='text-lg sm:text-2xl font-bold lg:group-hover:text-text-primary-100 text-text-primary-100'>?</span>
                            </div>
                            <span
                                class='lg:group-hover:text-primary-100 text-text-primary-100'><?php echo $faq['question_product']; ?></span>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-4 w-4 sm:h-6 sm:w-6 lg:group-hover:stroke-primary-100 stroke-text-primary-100"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class='h-15 w-full mb-3 transition-all duration-200  rounded-md max-h-0 overflow-hidden'>
                        <div class='mt-3 mr-14 p-3 bg-white-100 border rounded-md'>
                            <span
                                class='font-normal text-text-primary-100'><?php echo $faq['answer_product']; ?></span>
                        </div>
                    </div>
                    <?php } ?>
                </div>
                ...
                <div
                    ...
                    ?>
                    <div class='<?php echo ( can_see( $episode['episode_product_purchase_status'] , $episode['episode_product_show_status']  , get_the_ID() ) == 'play'  ) ? 'btn-episodes hover:cursor-pointer' : '' ?> <?php echo ( $episode['episode_product_number'] == 1 &&  can_see( $episode['episode_product_purchase_status'] , $episode['episode_product_show_status']  , get_the_ID() ) == 'play' ) ? 'border border-primary-100 ' : '' ?> group w-full h-fit flex mb-2 justify-between items-center bg-white-100 text-sm sm:text-base font-normal p-4 text-text-primary-100 rounded-lg' data-video="<?php echo $episode['episode_product_video']; ?>">
                        <div
                            class='h-fit flex flex-col items-center py-[5px] px-[10px] rounded-lg bg-background-100 ml-2 font-bold text-text-primary-100 <?php echo ( can_see( $episode['episode_product_purchase_status'] , $episode['episode_product_show_status']  , get_the_ID() ) == 'play'  ) ? 'group-hover:text-primary-100' : '' ?>'>
                            <?php echo $episode['episode_product_number']; ?>
                        </div>
                        <div class='flex flex-wrap flex-grow justify-start items-center' >
                            <span
                                class='h-fit font-normal text-text-primary-100 <?php echo ( can_see( $episode['episode_product_purchase_status'] , $episode['episode_product_show_status']  , get_the_ID() ) == 'play'  ) ? 'group-hover:text-primary-100' : '' ?>'>
                                <?php echo $episode['episode_product_title']; ?>
                            </span>
                            <div
                                class='h-fit flex justify-end flex-grow items-center text-xs sm:text-[0.9rem]'>
                                <div class='h-full flex items-center text-text-primary-100'>
                                ...
                                <div
                                    class='mr-2 h-fit flex items-center bg-background-100 text-text-primary-100 px-2 py-1 font-normal rounded-md <?php echo ( can_see( $episode['episode_product_purchase_status'] , $episode['episode_product_show_status']  , get_the_ID() ) == 'play'  ) ? '' : '' ?>'>
            ...
            <div class="w-full lg:w-[calc(25%-8px)] lg:order-1">
                ...
                <div
                    ...
                    <span class='text-lg font-bold mt-[5px] text-justify text-text-primary-100'>

                    </span>
                    <span class='text-[0.9rem] text-justify font-normal text-text-primary-100'>
                        <?php the_title(); ?>
                    </span>
                    <span class='text-[0.9rem] text-justify font-normal	my-2 text-text-primary-100'>
                        <?php the_excerpt(); ?>
                    </span>
                </div>
                <?php
