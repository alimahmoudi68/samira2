...
<div class='flex justify-between mb-1 md:mb-3'>
    <div class='text-lg flex items-center font-semibold text-gray-600 py-2 dark:text-text-primary-100'>
        ...
        <span class="text-xl md:text-3xl font-bold">دوره‌های حضوری</span>
    </div>
    ...
    <div class="w-full swiper-container swiper slider-prducts" dir="rtl">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <?php
                    wc_get_template_part( 'template/card', 'inPersonCourseSlider' );
                ?>  
            </div>
