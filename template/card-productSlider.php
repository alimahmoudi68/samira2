    ...
    <div
        ...
        <div class='w-full flex justify-between items-end text-sm font-light h-[40px] p-3'>
            <div class='flex items-center gap-x-2'>
                <div class='flex justify-center items-center rounded-md bg-primary-50 text-text-primary-100 p-1'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} class="stroke-text-primary-100 w-4 h-4 ml-1">
            ...
            <div class='flex flex-col justify-center font-medium text-text-primary-100'>
                <?php 
                if($type !== 'free'){
                ?>
                <?php if($sale_price !== '') {?> 
