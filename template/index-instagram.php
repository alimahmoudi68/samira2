...
<div class="w-full p-[16px] max-w-[1536px] mx-auto bg-section-pattern flex items-center flex-col md:flex-row justify-between gap-y-4 text-center md:text-right md:h-40 lg:h-40 rounded-2xl mb-[50px] md:mb-[70px]">
    <div class="text-text-primary-100 space-y-4">
    ...
    <a href="instagram://user?<?php echo $my_opt['opt-insta'] ?>" class="bg-white-50 inline-flex items-center shrink-0 text-base h-12 px-2 gap-x-0.5 rounded-xl text-[#502ED6] sm:bg-white-100  border border-transparent hover:border-white-100 hover:text-text-primary-100 hover:bg-transparent transition-colors">
